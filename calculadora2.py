...
Boton_suma=Button(ventana,text="Sumar",width=13,height=3,font=('arial black',10,'bold'),bg="#003300",fg="#ffffff").place(x=30,y=110)
Boton_resta=Button(ventana, text="Restar", width=13,height=3,font=('arial black',10,'bold'),bg="#660000",fg="#ffffff").place(x=220,y=110)
Boton_multiplica=Button(ventana, text="Multiplicar", width=13,height=3,font=('arial black',10,'bold'),bg="#000033",fg="#ffffff").place(x=30,y=210)
Boton_divide=Button(ventana, text="Dividir", width=13,height=3,font=('arial black',10,'bold'),bg="#330000",fg="#ffffff").place(x=220,y=210)
